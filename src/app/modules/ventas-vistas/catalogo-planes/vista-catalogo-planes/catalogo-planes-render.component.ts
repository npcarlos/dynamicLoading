...
import { ItemTemplate } from 'src/app/modules/visual-components/elementos/item.interface';
import { CatalogoRenderTemplate } from 'src/app/modules/visual-components/elementos/catalogo-generico/catalogo.component';
